...
# puppy_description = ['adaptive','babyish','badass','classy','clingy','flawed','flexible','great','needy','outward','perfect','reactive','sad','sporty','territorial','tidy','active','adventurous','affectionate','aggressive','annoying','brave','cheerful','confident','cowardly','decisive','determined','easygoing','enthusiastic']
