...
# - - - Conference objects - - - - - - - - - - - - - - - - -
    ...
    def filterPlayground(self, request):
        """Return filtered conferences to users"""
        # conferences = Conference.query(Conference.topics == "Medical Innovations").order(Conference.name)
        q=Conference.query()
